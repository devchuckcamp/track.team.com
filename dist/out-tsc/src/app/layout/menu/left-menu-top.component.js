...
var LeftMenuTopComponent = /** @class */ (function () {
    function LeftMenuTopComponent(http, router, route, projectService) {
        this.http = http;
        this.router = router;
        this.route = route;
    ...
    LeftMenuTopComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    LeftMenuTopComponent.prototype.ngAfterViewInit = function () {
    ...
    LeftMenuTopComponent.prototype.createUrlVariables = function (path) {
        //Get Url
    ...
    ], LeftMenuTopComponent.prototype, "project_name", void 0);
    tslib_1.__decorate([
        Input('admin_project_sub'),
        tslib_1.__metadata("design:type", String)
    ], LeftMenuTopComponent.prototype, "admin_project_sub", void 0);
    tslib_1.__decorate([
        Input('auth_profile'),
        tslib_1.__metadata("design:type", Object)
    ], LeftMenuTopComponent.prototype, "auth_profile", void 0);
    tslib_1.__decorate([
        Input('auth_client'),
        tslib_1.__metadata("design:type", Object)
    ], LeftMenuTopComponent.prototype, "auth_client", void 0);
    LeftMenuTopComponent = tslib_1.__decorate([
        Component({
    ...
    return LeftMenuTopComponent;
}());
export { LeftMenuTopComponent };
//# sourceMappingURL=left-menu-top.component.js.map